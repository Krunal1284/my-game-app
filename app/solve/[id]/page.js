      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .right-panel { width: 100%; flex: 1; display: flex; flex-direction: column; overflow: hidden; }
          .editor-area { flex-shrink: 0; height: 220px; }
          .code-wrap { height: 180px; overflow: hidden; }
          .code-textarea { height: 100%; overflow-y: auto; }
          .bottom-panel { flex: 1 !important; height: auto !important; overflow: hidden; display: flex; flex-direction: column; }
